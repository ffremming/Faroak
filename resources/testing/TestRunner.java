...
import resources.testing.probes.WeaponSwingArtProbe;
...
import resources.testing.probes.FarmBorderConnectProbe;
...
import resources.testing.probes.DeadInputFreezeProbe;
import resources.testing.probes.DeathScreenProbe;
import resources.testing.probes.DeathRespawnClickProbe;
...
public final class TestRunner {
    ...
    public static void main(String[] args) {
        ...
        probes.add(new DeadInputFreezeProbe());
        probes.add(new DeathScreenProbe());
        probes.add(new DeathRespawnClickProbe());
        ...
        probes.add(new FarmBorderConnectProbe());
        ...
        probes.add(new WeaponSwingArtProbe());
